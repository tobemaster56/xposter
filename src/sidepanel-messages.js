(() => {
  function register(i18n, shared, constants = {}) {
    ...
    const ZH_TEXT = new Map(
      ...
      "No Markdown yet": "还没有 Markdown",
      "Paste in the editor above, or choose a .md file.": "在上方编辑框粘贴，或选择 .md 文件。",
      ...
      "Retry request failed: active X tab did not respond": "重试请求失败：当前 X 标签页没有响应",
      ...
      "Batch complete": "批量完成",
      "Batch stopped": "批量已停止",
      "Success {done}/{total} drafts": "成功 {done}/{total} 篇",
      ...
      Auto: "自动",
      "Choose the folder that contains relative image paths in your Markdown.": "写入时，xPoster 会在 X 页面内询问本地图片文件夹。",
      ...
      "Article import": "文章导入",
      "Choose metadata and safe text cleanup before writing to X.": "选择写入 X 前的元信息和安全文本清理。",
      ...
      "Draft cleanup": "草稿清理",
      "Choose safe text cleanup before writing to X.": "选择写入 X 前的安全文本清理。",
      "Text cleanup": "文本清理",
      "Smart punctuation": "智能标点",
      "Fix punctuation in visible article text while leaving code and links unchanged.": "修正文章可见文本中的标点，并保持代码和链接不变。",
      "Fix visible Chinese punctuation while leaving code, links, and URLs unchanged.": "修正可见中文标点，并保持代码、链接和 URL 不变。",
      ...
      "Supports headings, lists, links, images, tables, tweet links, code blocks, and dividers. Web image links need a one-time Chrome approval; local image paths need a folder in Settings.": "支持标题、列表、链接、图片、表格、推文链接、代码块和分割线。网页图片写入时自动尝试处理；本地图片路径会在 X 页面内询问文件夹。",
      ...
      "Opening X Articles so the page can ask for the local image folder.": "正在打开 X 文章页，稍后会在页面内询问本地图片文件夹。",
      "open an X page first": "请先打开 X 页面",
      "Local image folder needed": "需要本地图片文件夹",
      "Local image path blocked": "本地图片路径已阻止",
      "Local images need a folder. xPoster will ask inside the X page.": "本地图片需要文件夹。xPoster 会在 X 页面内询问。",
      ...
      "Check editor": "检查编辑器",
      "Choose local image folder": "在 X 页面选择本地图片文件夹",
      "Relative image paths need a readable folder selected from the active X tab.": "相对图片路径会在写入时从 X 页面选择一个可读取文件夹。",
      ...
      "Open X Articles; xPoster will ask for the local image folder there.": "打开 X 文章页，xPoster 会在那里询问本地图片文件夹。",
      ...
      "Local image folder selected. Continuing import.": "本地图片文件夹已选择，继续导入。",
      ...
      "On published X Article pages, show Markdown tools beside the article title.": "在已发布的 X 文章页，把 Markdown 工具显示在文章标题旁。",
      "Published article Markdown tools": "已发布文章 Markdown 工具",
      "Copy or download a readable X Article as Markdown from its title area.": "在可读取的 X 文章标题区，将文章复制或下载为 Markdown。",
      Done: "完成",
      Blocked: "阻塞",
      Running: "运行中",
      Idle: "空闲",
