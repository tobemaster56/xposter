(() => {
  function register(i18n, shared, constants = {}) {
    ...
    const ZH_TEXT = new Map(
      ...
      "Keep Markdown tools beside readable X Article titles.": "将 Markdown 工具放在可读取的 X 文章标题旁。",
      "Title Markdown tools": "标题区 Markdown 工具",
      "Copy or download the article without adding a separate button row.": "复制或下载文章，不额外添加一排按钮。",
      Done: "完成",
      Blocked: "阻塞",
      Running: "运行中",
      Idle: "空闲",
