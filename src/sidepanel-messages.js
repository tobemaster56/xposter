(() => {
  function register(i18n, shared, constants = {}) {
    ...
    const ZH_TEXT = new Map(
      ...
      "Uploading prepared images through X.": "正在通过 X 上传准备好的图片。",
      ...
      "Tables are placed as Markdown table blocks.": "表格会作为 Markdown 表格块插入文章。",
      "Open the X editor and run Check so tables can be placed.": "打开 X 编辑器并运行检查后即可放置表格。",
